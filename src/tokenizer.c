...
static op_details_t ops[] = {
        ...
        {	OP_STAR,		"*",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_COMMA,		",",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_PLUS,		"+",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_MINUS,		"-",	0,	1,	1,	0,	0,	0,	NULL	},
        {	OP_DIV,			"/",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_COLON,		":",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_SEMICOLON,		";",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_DOT,			".",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_LARGER,		">",	1,	0,	1,	0,	0,	0,	NULL	},
        {	OP_LARGEROREQUAL, 	">=",	1,	0,	1,	0,	0,	0,	NULL	},
        {	OP_LESS,		"<",	1,	0,	1,	0,	0,	0,	NULL	},
        {	OP_LESSOREQUAL,		"<=",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_ASSIGN,		"=",	0,	0,	0,	0,	1,	0,	NULL	}, 
        {	OP_ASSIGNADD,		"+=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNSUB,		"-=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNMULT,		"*=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNDIV,		"/=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNMOD,		"%=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNBITOR,		"|=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNBITAND,	"&=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNBITXOR,	"^=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNSHIFTLEFT,	"<<=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_ASSIGNSHIFTRIGHT,	">>=",	0,	0,	0,	0,	1,	0,	NULL	},
        {	OP_BITXOR,		"^",	1,	1,	1,	0,	0,	0,	NULL	},
        {	OP_BITOR,		"|",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_BITAND,		"&",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_EQUAL,		"==",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_NOTEQUAL,		"!=",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_SHIFTLEFT,		"<<",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_SHIFTRIGHT,		">>",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_LOGICAND,		"&&",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_LOGICOR,		"||",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_LOGICXOR,		"^^",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_BITINV,		"~",	1,	1,	0,	0,	0,	0,	NULL	},
        {	OP_MOD,			"%",	1,	0,	1,	0,	0,	0,	NULL	},
