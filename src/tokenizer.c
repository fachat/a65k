...
// - assign
// - priority
// - operation function (left, right) -> result, left only for unary
//
// TODO: different prio for unary/binary of same OP. 
// TODO: right before left vs. left before right of same operator
static op_details_t ops[] = {
        { 	OP_NONE,		"",	0,	0,	0,	0,	0,	0,	NULL	},
        { 	OP_EXCL,		"!",	1,	1,	0,	0,	0,	2,	NULL	},
        {	OP_AT,			"@",	1,	0,	0,	0,	0,	0,	NULL	},
        {	OP_XQUOTE,		"`",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_SQUOTE,		"'",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_OPEN,		"(",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_CLOSE,		")",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_HASH, 		"#",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_BOPEN,		"[",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_COPEN,		"{",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_BBOPEN,		"[[",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_BCLOSE,		"]",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_CCLOSE,		"}",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_BBCLOSE,		"]]",	0,	0,	0,	0,	0,	0,	NULL	}, 
        {	OP_STAR,		"*",	0,	0,	1,	0,	0,	3,	NULL	},
        {	OP_COMMA,		",",	0,	0,	0,	0,	0,	15,	NULL	},
        {	OP_PLUS,		"+",	0,	0,	1,	0,	0,	4,	NULL	},
        {	OP_MINUS,		"-",	0,	1,	1,	0,	0,	4,	NULL	},
        {	OP_DIV,			"/",	0,	0,	1,	0,	0,	3,	NULL	},
        {	OP_COLON,		":",	0,	0,	0,	0,	0,	15,	NULL	},
        {	OP_SEMICOLON,		";",	0,	0,	0,	0,	0,	15,	NULL	},
        {	OP_DOT,			".",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_LARGER,		">",	1,	0,	1,	0,	0,	6,	NULL	},
        {	OP_LARGEROREQUAL, 	">=",	1,	0,	1,	0,	0,	6,	NULL	},
        {	OP_LESS,		"<",	1,	0,	1,	0,	0,	6,	NULL	},
        {	OP_LESSOREQUAL,		"<=",	0,	0,	1,	0,	0,	6,	NULL	},
        {	OP_ASSIGN,		"=",	0,	0,	0,	0,	1,	14,	NULL	}, 
        {	OP_ASSIGNADD,		"+=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNSUB,		"-=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNMULT,		"*=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNDIV,		"/=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNMOD,		"%=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNBITOR,		"|=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNBITAND,	"&=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNBITXOR,	"^=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNSHIFTLEFT,	"<<=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_ASSIGNSHIFTRIGHT,	">>=",	0,	0,	0,	0,	1,	14,	NULL	},
        {	OP_BITXOR,		"^",	1,	1,	1,	0,	0,	9,	NULL	},
        {	OP_BITOR,		"|",	0,	0,	1,	0,	0,	10,	NULL	},
        {	OP_BITAND,		"&",	0,	0,	1,	0,	0,	8,	NULL	},
        {	OP_EQUAL,		"==",	0,	0,	1,	0,	0,	7,	NULL	},
        {	OP_NOTEQUAL,		"!=",	0,	0,	1,	0,	0,	7,	NULL	},
        {	OP_SHIFTLEFT,		"<<",	0,	0,	1,	0,	0,	5,	NULL	},
        {	OP_SHIFTRIGHT,		">>",	0,	0,	1,	0,	0,	5,	NULL	},
        {	OP_LOGICAND,		"&&",	0,	0,	1,	0,	0,	11,	NULL	},
        {	OP_LOGICOR,		"||",	0,	0,	1,	0,	0,	12,	NULL	},
//        {	OP_LOGICXOR,		"^^",	0,	0,	1,	0,	0,	0,	NULL	},
        {	OP_BITINV,		"~",	1,	1,	0,	0,	0,	2,	NULL	},
        {	OP_MOD,			"%",	1,	0,	1,	0,	0,	3,	NULL	},
        {	OP_DOUBLESLASH,		"//",	0,	0,	0,	0,	0,	0,	NULL	},
        {	OP_XIND,		",X",	0,	0,	0,	1,	0,	0,	NULL	},
        {	OP_YIND,		",Y",	0,	0,	0,	1,	0,	0,	NULL	},
        {	OP_ZIND,		",Z",	0,	0,	0,	1,	0,	0,	NULL	},
        {	OP_SIND,		",S",	0,	0,	0,	1,	0,	0,	NULL	},
        {	OP_BIND,		",B",	0,	0,	0,	1,	0,	0,	NULL	},
        {	OP_PIND,		",P",	0,	0,	0,	1,	0,	0,	NULL	},
};
